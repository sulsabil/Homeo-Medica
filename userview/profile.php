...
<head>
    ...
    <title><?php echo Session::get('name') == null ? '' : Session::get('name') ?> | Homeo Medica</title>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <ul class="notifications">
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-menu dropdown-menu-right notificationList" aria-labelledby="alertsDropdown">
                                <?php
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="profile-img">
                        <img src="uploads/<?php echo Session::get('image') == null ? 'default_user.png' : Session::get('image'); ?>" alt="" />
                    </div>
                    <form id="form-data" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control" name="name" placeholder="User name" value="<?php echo Session::get('name') == null ? '' : Session::get('name') ?>" />
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail">Email address</label>
                            <input type="email" class="form-control" name="email" disabled value="<?php echo Session::get('email') == null ? '' : Session::get('email') ?>" />
                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputContact">Contact</label>
                            <input name="phone" type="text" class="form-control" value="<?php echo Session::get('phone') == null ? '' : Session::get('phone') ?>" />
                        </div>
                        <?php
                        ...
                        ?>
                            <div class="form-group">
                                ...
                                <input type="specialists" class="form-control" name="specialists" placeholder="Specialists" value="<?php echo $value == null ? '' : $value; ?>" />
                            </div>
                        <?php } ?>

                        <div class="form-group">
                            <label for="exampleInputName">Address</label>
                            <input type="address" class="form-control" name="address" placeholder="Address" value="<?php echo Session::get('address') == null ? '' : Session::get('address') ?>" />
                        </div>
                        <div class="form-group">
