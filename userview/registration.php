...
<head>
    ...
    <title>Registration | Homeo Medica</title>
                ...
                <div class="col-md-6">
                    <form id="form-data" enctype="multipart/form-data" method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="name" class="form-control" placeholder="Name" autocomplete="off" name="name" />
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Contact" name="phone" id="phone" autocomplete="off" />
                            </div>
                        </div>
                        <div class="form-group row">
