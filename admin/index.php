...
<head>
    ...
    <title>Admin Dashboard || Homeo Medica</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
        <a class="navbar-brand mr-1" href="index.php">Homeo Medica</a>
        ...
        <ul class="navbar-nav ml-auto ml-md-0">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img style="width: 30px; height: 30px" src="resource/img/user3.png" class="rounded-circle" alt="Avatar" />
                    <span><?php echo Session::get("name"); ?></span>
                    <i class="icon-submenu lnr lnr-chevron-down"></i>
                </a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    <div class="dropdown-divider"></div>
                    <a id="logoutBtn" class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">Logout</a>
                </div>
            </li>
        </ul>
    </nav>
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
            <li class="nav-item dropdown active">
                <a class="nav-link" href="index.php" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
